...
public class PNREnquiryActivity extends Activity implements OnClickListener {
	...
	HttpClient client;
	Intent i;
	//final static String Url = "http://www.mmtstraintimings.in/pnrstatus/";
	final static String Url = "http://ipnrstatus.in/";
	String result;
	...
	private class DownloadWebPageTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			nError = false;
			Toast.makeText(context, "Fetching PNR status..Please wait..",
	...
	private class UpdateDataBase extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			String responsereturn = "";
			try {
				datasource = new PNRDataSource(PNREnquiryActivity.this); // insert
																			// in
																			// database
				datasource.open();
